...
$q->execute(array($drying,$wid2));
		...
		$rname = $rowm['name'];	
					...
					if($job_type==3){ $type_color="green"; $type_info="Service"; }
					if($job_type==6){ $type_color="blue"; $type_info="Body Detailing"; }
                    if($job_type==5){ $type_color=""; $type_info="Mechanical"; }
					  ...
					  ?>
                                        ...
                                        <tr class="alert alert-general record" style="background-color:brown">
                                            ...
                                            <td><?php echo $row['vehicle_no'];?>
                                                ...
                                                <?php  if($ramp>0){?>
                                                <span class="badge bg-red"><?php echo $ttime_on." ".$ttime_type;?>
                                                </span>
                                                <?php } ?>

                                                <?php  }if($ramp=="Drying"){?>
                                                <i class="fa fa-sun-o" style="color: darkorange"><span
                                                        class="badge bg-yellow"><?php echo $wtime_on." ".$wtime_type;?>
                                                    </span></i>
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td><span class="badge bg-<?php echo $color;?>"><i
                                                    ...
                                                    <?php echo $time_on." ".$time_type;?></span></td>


                                            <td><span
                                                    class="badge bg-<?php echo $color_ramp;?>"><?php echo $info;?></span>
                                            </td>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tbody>
                                        <?php $color="green";
			$result = $db->prepare("SELECT * FROM model ORDER by amount DESC limit 0,7");
				$result->bindParam(':userid', $date);
                $result->execute();
                for($i=0; $row = $result->fetch(); $i++){
