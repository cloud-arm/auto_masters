...
date_default_timezone_set("Asia/Colombo");
	...
	$result1 = $connect->prepare("SELECT * FROM sales WHERE  invoice_number='$invoice_no'  ");
		...
		$result = $connect->prepare("SELECT * FROM customer WHERE  id='$cus_id'  ");
		$result->bindParam(":userid", $res);
		$result->execute();
				...
				<table  cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td valign="top" width="50%">
							<img src="../jmw.png" alt="Logo" style="max-width:150px;"><br>
							 
         <p>No 85 , jayasewana road , <br>
		 Kalubowila ,<br>
		  Dehiwala. <br><br>
		  Call: 0112 150 400<br>
		  E-mail: Jmwsrilanka@gmail.com<br>
...
//$name="RHN TRADING COMPANY (PVT) LTD";
	...
	$mail->Host = 'https://mail.cloudarmsoft.com';		//Sets the SMTP hosts of your Email hosting, this for Godaddy
	$mail->Port = '587';								//Sets the default SMTP server port
	$mail->SMTPAuth = true;							//Sets SMTP authentication. Utilizes the Username and Password variables
	$mail->Username = '	autodimension@cloudarmsoft.com';					//Sets SMTP username
	$mail->Password = 'Eranda12345.';					//Sets SMTP password
	$mail->SMTPSecure = '';							//Sets connection prefix. Options are "", "ssl" or "tls"
	$mail->From = '	autodimension@cloudarmsoft.com';			//Sets the From email address for the message
	$mail->FromName = 'Janaka Motor Works';			//Sets the From name of the message
