                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control select2" name="name"
                                                            ...
                                                            <?php  $invo = $_GET['id'];
         $result = $db->prepare("SELECT * FROM product WHERE NOT type='Materials' ");
...
$style='style="color:red" ';
	...
	?>
                                        <tr <?php echo $style; ?>>
                                            ...
                                            <td><form action="sales_list_edit_qty.php" method="post">
                                              <input style="text-align: right;" type="number" class="form-control" name="qty" value="<?php echo $row['qty']; ?>" id="">
